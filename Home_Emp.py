...
class win1:
    def __init__(self,root):
        ...
        self.root.configure(background = "#f0f0f0")  # background color for window 
...
#-----------------Main Screen Frames---------------------------------
        ...
        F4 = LabelFrame(self.root,bd=10,relief=GROOVE,bg="#3B9C9C")
        F4.place(x=290,y=200,width=400,height=300 )

        F41 = LabelFrame(F4,bd=5,relief=SUNKEN,bg="#3B9C9C")
        F41.place(x=0,y=0,width=380,height=60 )
        lbl_2= Label(F41,text="Total Students",bg="#3B9C9C",font=("times new roman",22,"bold"),fg="White")
        lbl_2.place(x=0,y=0)

        F42 = LabelFrame(F4,bd=5,relief=GROOVE)
        F42.place(x=0,y=60,width=380,height=220 )

        text1=Text(F42,bd=5, font=("times new roman",28,"bold"))
        ...
        F6 = LabelFrame(self.root,bd=10,relief=GROOVE,bg="#3B9C9C")
        F6.place(x=820,y=200,width=400,height=300 )

        F61 = LabelFrame(F6,bd=5,relief=SUNKEN,bg="#3B9C9C")
        F61.place(x=0,y=0,width=380,height=60 )
        lbl_4= Label(F61,text="Total Employees",bg="#3B9C9C",font=("times new roman",22,"bold"),fg="White")
        lbl_4.place(x=0,y=0)

        F62 = LabelFrame(F6,bd=5,relief=GROOVE)
        F62.place(x=0,y=60,width=380,height=220 )

        text3=Text(F62,bd=5, fg="white",font=("times new roman",28,"bold"),bg="#151B54")
        self.c.execute("SELECT COUNT(*) FROM Emp")
        self.results3 = ((self.c).fetchall())        
        text3.insert(INSERT,("\n             Total\n         Employees: "))
        text3.insert(INSERT,self.results3)
        text3.place(x=0,y=0,width=370,height=210)
