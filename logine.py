...
class win1:
    def __init__(self,root):
        ...
        lbl = Label(F1,text="LOGIN As Employee ", bg=bg_color, fg="gold", font= ("times new roman",30,"bold"))
        ...
        btn_switch = Button(F1, text="Login as Admin", relief=FLAT, command=self.login3, font=("times new roman",12,"underline"), bg=bg_color, fg="gold", cursor="hand2")
